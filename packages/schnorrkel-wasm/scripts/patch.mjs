// See https://github.com/rustwasm/wasm-pack/issues/1334

import { readFile, writeFile } from "node:fs/promises"

const cargoTomlContent = await readFile("./rust/Cargo.toml", "utf8")
...
await writeFile(`./dist/nodejs/${name}.mjs`, patched)
